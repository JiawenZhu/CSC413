...
public abstract class AnimationPanel extends JPanel implements Runnable {
    ...
    protected final int SET_HEIGHT = 760;
    protected final String BACKGROUND_IMAGE = "tankGame/resource/Background.bmp";
    protected final String TANK_IMAGE = "tankGame/resource/TankImage.png";
    ...
    public AnimationPanel() {
        try {
          ...
          this.breakableWall = new WallObject("tankGame/resource/Wall1.gif");
    ...
    public void paintComponent( Graphics graphics ) {
        ...
        miniGraphic.drawImage(miniImage, HEIGHT/2- 175, 0, 300, 300,this);
